...
#define COLOR_BACKGROUND_RED_ID 5
#define COLOR_BACKGROUND_GREEN_ID 6
#define COLOR_BACKGROUND_YELLOW_ID 7
#define COLOR_BACKGROUND_BLUE_ID 8
#define COLOR_BACKGROUND_MAGENTA_ID 9
